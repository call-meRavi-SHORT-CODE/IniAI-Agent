...
class PlannerAgent:
    """Planner Agent powered by LangChain + Groq LLM"""

    def __init__(self, model_id: str = ""):
        # Initialize the LLM
        self.llm = ChatGoogleGenerativeAI(model="gemini-2.0-flash", google_api_key=GOOGLE_API_KEY)

        # Define structured prompt template (no Jinja2 needed)
        ...
        # Parser to convert model output to plain text
        ...
        for line in response.split("\n"):
            ...
            if line.startswith("Project Name:"):
                ...
                if match:
                    ...
                    # Continuation of previous step text
